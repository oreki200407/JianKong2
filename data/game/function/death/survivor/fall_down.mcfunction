...
#對齊中心 召喚盔甲座
summon item_display ~ ~ ~ {CustomNameVisible:1b,Tags: ["death_stand", "new_stand"],CustomName:'[{"text": "按住", "color": "gray", "italic": false}, {"keybind": "key.sneak"}, "救援"]',billboard:"vertical",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,180f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:player_head",count:1}}
