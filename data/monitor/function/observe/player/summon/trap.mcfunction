...
#2
execute if score @s trap matches 2 run return run summon potion ~ ~ ~ {Item: {id: "lingering_potion", components: {"custom_name": '{"text": "燃燒瓶", "color": "aqua", "bold": true, "italic": false}', "potion_contents": {"custom_color": 4144959}, "max_stack_size": 64, "hide_additional_tooltip": {}, "custom_data": {"gadget": "molotov_cocktail"}}}}
