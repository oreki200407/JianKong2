...
execute at @e[type=marker, tag=control_box_off] run setblock ~ ~ ~ oak_wall_sign[facing=north]{front_text:{messages:["",{bold:1b,text:"關閉電箱"},{bold:1b,click_event:{action:"run_command",command:"function control:box_off/use"},text:"花費：50電力"},""]},is_waxed:1b}
