...
execute unless entity @e[type=armor_stand, tag=poison_setting] run return run function edit:poison/fail
...
execute as @e[type=armor_stand, tag=poison_setting] at @s run function edit:poison/save
kill