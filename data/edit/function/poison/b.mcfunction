...
execute unless entity @e[tag=poison_setting, type=armor_stand, limit=1] run return run function edit:poison/fail
...
execute as @e[tag=poison_setting, type=armor_stand] at @s run function edit:poison/save
kill