...
execute unless items entity @s weapon tripwire_hook[item_name="滅火器",damage=10] run return run item modify entity @s weapon {function: "set_damage", add: true, damage: -0.11}
