...
execute align xz run summon text_display ~.5 ~ ~.5 {text: ["30"], billboard: "vertical", Tags: ["one_box","new_one_box"],transformation: {left_rotation: [0f, 0f, 0f, 1f], right_rotation: [0f, 0f, 0f, 1f], translation: [0f, 2.2f, 0f], scale: [1f, 1f, 1f]}}
