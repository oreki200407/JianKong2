...
execute if score @s unlock_progess matches 0..1 run return run title @s actionbar [{text: "開鎖中：", color: "gold", bold: true}, {text: "▬▬▬▬▬▬▬▬▬▬", color: "gray"}]
...
execute if score @s unlock_progess matches 4..5 run return run title @s actionbar [{text: "開鎖中：▬▬▬", color: "gold", bold: true}, {text: "▬▬▬▬▬▬▬", color: "gray"}]
