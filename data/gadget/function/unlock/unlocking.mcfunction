...
#移動了就失敗
execute if predicate game:moving/generic run return run function gadget:unlock/fail
...
#達到100%後 要拿著才會繼續
execute if items entity @s weapon tripwire_hook[custom_data~{gadget: "unlock"}] run function gadget:unlock/success