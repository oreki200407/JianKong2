...
execute unless block ~ ~ ~ #air unless block ~ ~ ~ #wooden_doors[open=true] run return run scoreboard players reset @s flamethrower
execute if score @s flamethrower matches 6.. run return run scoreboard players reset @s flamethrower

#往前1格
execute positioned ^ ^ ^1 run function gadgets:extinguisher/shoot