...
execute at @e[type=text_display, tag=one_box] positioned ~ ~-2.2 ~ run function box:use/reset
...
execute as @s[scores={box_operation=1}] run return run function box:use/success/water/root
execute store success score @s box_operation run clear @s redstone[item_name={"text":"電力破壞","color":"gold"}]
execute as @s[scores={box_operation=1}] run return run function box:use/success/power
execute store success score @s box_operation run clear @s redstone[item_name={"text":"禁止監控","color":"gold"}]
execute as @s[scores={box_operation=1}] run return run function box:use/success/monitor/root
execute store success score @s box_operation run clear @s redstone[item_name={"text":"轉移怪物","color":"gold"}]
execute as @s[scores={box_operation=1}] run return run function box:use/success/transfer/root
execute store success score @s box_operation run clear @s redstone[item_name={"text":"鐵門解鎖","color":"gold"}]
execute as @s[scores={box_operation=1}] run return run function box:use/success/door
execute store success score @s box_operation run clear @s redstone[item_name={"text":"雙倍血量","color":"gold"}]
execute as @s[scores={box_operation=1}] run return run function box:use/success/health
