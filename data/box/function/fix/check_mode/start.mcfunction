...
#為什麼keybind的slot是1到9…
execute store result storage jk2:data root.box.fix.slot_keybind int 1 run scoreboard players add #slot_keybind fix_slot 1
#title按鍵
function box:fix/check_mode/title with storage jk2:data root.box.fix
