...
give @s raw_copper[item_model=spider_eye, item_name={text: "騎士", color: "gold"}, lore=[[{text: "騎在敏捷的", color: "white", italic: false}, {translate: "entity.minecraft.skeleton_horse"}, "上"], {text: "冷卻10秒", color: "aqua", italic: false}], custom_data={skill: 2b}, consumable={animation: "none", has_consume_particles: false, consume_seconds: 0.0F, sound: "intentionally_empty"}]