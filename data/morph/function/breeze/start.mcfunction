...
item modify entity @s armor.head {function: "set_components", components: {item_name: {translate: "entity.minecraft.blaze"}, lore: [[{text: "被動技能：永久", color: "white", italic: false}, {translate: "effect.minecraft.wind_charged"}, "效果"]], profile: {properties: {textures: ["eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODA4NDNhOTRmOTI1YjU1OTg5MjRmZjliNTJiNzk5OWM4ZDI5ZDFiNzkwYWQ0ODdkZDU0ZTI3OTU2ZTU0MGQyMCJ9fX0="]}}}}
