...
item modify entity @s armor.head {function: "set_components", components: {item_name: {translate: "entity.minecraft.spider"},lore: [{text: "被動技能：按住", italic: false}, {"keybind": "key.sneak", italic: false}, {text: "可爬墻", italic: false}], profile: {id: [I; -1948552752, 1193560242, -1824200812, -2143139944], properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2Q1NDE1NDFkYWFmZjUwODk2Y2QyNThiZGJkZDRjZjgwYzNiYTgxNjczNTcyNjA3OGJmZTM5MzkyN2U1N2YxIn19fQ=="}]}}}
