...
item replace entity @s armor.chest with elytra[unbreakable={}, tooltip_display={hidden_components: ["unbreakable", "enchantments", "attribute_modifiers"]}, enchantment_glint_override=false, enchantments={binding_curse: 1}, attribute_modifiers=[{type: "scale", id: "jk2:phantom", amount: -0.5, operation: "add_value", slot: "chest"}]]
