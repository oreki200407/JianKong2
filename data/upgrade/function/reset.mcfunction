...
item replace entity @s enderchest.1 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.2 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.3 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.4 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.5 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.6 with white_stained_glass_pane[custom_name='""']
item replace entity @s enderchest.7 with barrier[custom_name='""']
...
item replace entity @s enderchest.13 with barrier[custom_name='""']
...
item replace entity @s enderchest.16 with barrier[custom_name='""']
...
item replace entity @s enderchest.25 with barrier[custom_name='""']
