...
execute store result entity @s data.range double 0.01 run random value 1000..2000
execute at @s run function monster:boss/creeper/status/lightning/summon with entity @s data