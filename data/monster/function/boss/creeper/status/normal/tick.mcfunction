...
#每tick 5%
execute unless predicate monster:chance/5 run return fail
...
execute at @s run function monster:boss/creeper/status/normal/summon with entity @s ArmorItems[3].components."minecraft:custom_data"