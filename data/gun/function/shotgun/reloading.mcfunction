execute unless items entity @s container.* nether_brick[custom_data~{"ammo": "shotgun"}] run return run function gun:reload_fail
...
execute as @s[scores={reload_time=22}] run function gun:shotgun/reloaded