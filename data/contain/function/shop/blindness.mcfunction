...
give @s purple_dye[item_name="煙霧彈",custom_data={"type":"trap","command":"summon splash_potion ~ ~.1 ~ {Item:{id:\"splash_potion\",count:1,components:{\"potion_contents\":{custom_effects:[{id:\"blindness\",amplifier:0,duration:200}]}}}}"},custom_model_data={strings:["blindness_monitor"]}, consumable={consume_seconds: 99999}] 1
