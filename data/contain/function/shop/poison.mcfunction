...
give @s purple_dye[item_name={translate: "item.minecraft.splash_potion.effect.poison"},custom_data={"type":"trap","command":"summon splash_potion ~ ~.1 ~ {Item:{id:\"splash_potion\",count:1,components:{\"potion_contents\":{custom_effects:[{id:\"poison\",amplifier:1,duration:200}]}}}}"},custom_model_data={strings:["poison_monitor"]}, consumable={consume_seconds: 99999}] 1
