...
execute as @s[scores={summon_operate=1}] run return run function summon:operation/add

execute store success score @s summon_operate run clear @s glowstone_dust[custom_data~{summon:subtract}] 0
execute as @s[scores={summon_operate=1}] run return run function summon:operation/subtract
