...
execute store success score @s summon_operate run clear @s glowstone_dust[item_name={"text": "+1", "color": "green", "bold": true}]
scoreboard players add @s[scores={summon_operate=1}] summon_count 1

execute store success score @s summon_operate run clear @s glowstone_dust[item_name={"text": "+5", "color": "green", "bold": true}]
scoreboard players add @s[scores={summon_operate=1}] summon_count 5

execute store success score @s summon_operate run clear @s glowstone_dust[item_name={"text": "+10", "color": "green", "bold": true}]
