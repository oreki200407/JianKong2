...
execute as @e[type=armor_stand,tag=summon_picked] run function summon:operation/shuffle/set with entity @s equipment.chest.components."minecraft:custom_data"
