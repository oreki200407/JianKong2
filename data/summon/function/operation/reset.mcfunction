...
item replace entity @s enderchest.24 with glowstone_dust[custom_model_data={strings:["shuffle"]},item_name={"text": "刷新怪物", "color": "aqua", "bold": true},lore=[{"text": "消耗 20 電力", "color": "gray", "italic": false}]]
function summon:operation/shuffle/cooldown
