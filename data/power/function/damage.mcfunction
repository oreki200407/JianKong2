...
setblock ~ ~1 ~ oak_wall_sign[facing=south]{front_text:{messages:["",{"text":"修復發電機","bold":true},{"text":"花費：50電力","bold":true,"click_event":{"action":"run_command","command":"function power:fix_buy"}},""]},is_waxed:1b}
