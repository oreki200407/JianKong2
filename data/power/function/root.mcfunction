...
execute as @s[scores={light_game=1}] at @e[type=marker,tag=light_game] run return run function power:light_game/switch/root
...
execute as @s[scores={netwalk_game=1}] at @e[type=marker, tag=netwalk_game] run return run function power:netwalk_game/switch/root