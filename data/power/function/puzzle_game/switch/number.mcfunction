...
execute as @s[scores={puzzle_game=1}] unless entity @e[type=marker, tag=puzzle_game,distance=..0.1] run data modify storage jk2:data root.monitor.puzzle_game.chest2 set value 1
