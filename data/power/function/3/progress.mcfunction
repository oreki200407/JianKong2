...
execute if score #power3 power matches 3 run setblock ~4 ~2 ~ stone_button[face=floor,facing=north]

scoreboard players add #power3 power 1
execute if score #power3 power matches 4 run scoreboard players set #power3 power 0