...
#已經走過了
execute if items entity 0-0-0-0-171e7 contents *[custom_data~{pass: true}] run return 0
...
#單一連通
execute if items entity 0-0-0-0-171e7 contents *[custom_data~{rotate_data: {type: "single"}}] run function power:netwalk_game/check_win/search/single/root
#角落型態
execute if items entity 0-0-0-0-171e7 contents *[custom_data~{rotate_data: {type: "corner"}}] run function power:netwalk_game/check_win/search/corner/root
