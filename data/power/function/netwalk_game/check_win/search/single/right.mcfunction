###################################################
# 根據x_offset和index，對右邊的格子進行DFS
# 
# Name   : right.mcfunction
...
#對這兩個參數進行調整
scoreboard players add #index netwalk_game 1
...
#從左邊來
data modify storage jk2:data root.monitor.netwalk_game.macro.dfs.from set value 3
