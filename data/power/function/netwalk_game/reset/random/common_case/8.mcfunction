###################################################
# Make the Common Case Fast: 如果root.monitor.netwalk_game.nodes_vec2arr有八個向量
# 
# Name   : 8.mcfunction
...
execute store result storage jk2:data root.monitor.netwalk_game.macro.index int 1 store result score #random_index netwalk_game run random value 0..7
...
data modify storage jk2:data root.monitor.netwalk_game.node_vec2 set from storage jk2:data root.monitor.netwalk_game.nodes_vec2arr[7]