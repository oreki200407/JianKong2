...
#箱子內容
item replace block ~ ~ ~ container.0 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.1 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
...
item replace block ~ ~ ~ container.7 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.8 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]

item replace block ~ ~ ~ container.9 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.10 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
...
item replace block ~ ~ ~ container.16 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.17 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]

item replace block ~ ~ ~ container.18 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.19 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
...
item replace block ~ ~ ~ container.25 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~ ~ ~ container.26 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]

item replace block ~1 ~ ~ container.0 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.1 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
...
item replace block ~1 ~ ~ container.7 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.8 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]

item replace block ~1 ~ ~ container.9 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.10 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
...
item replace block ~1 ~ ~ container.16 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.17 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]

item replace block ~1 ~ ~ container.18 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.19 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.20 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.21 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.22 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.23 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.24 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.25 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
item replace block ~1 ~ ~ container.26 with magenta_glazed_terracotta[tooltip_display={hide_tooltip: true}]
