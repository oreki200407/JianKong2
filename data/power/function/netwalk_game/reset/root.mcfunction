...
item replace block ~ ~ ~ container.2 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.3 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.4 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.5 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.6 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
...
item replace block ~ ~ ~ container.11 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.12 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.13 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.14 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.15 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
...
item replace block ~ ~ ~ container.20 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.21 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.22 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.23 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~ ~ ~ container.24 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
...
item replace block ~1 ~ ~ container.2 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.3 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.4 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.5 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.6 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
...
item replace block ~1 ~ ~ container.11 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.12 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.13 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.14 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
item replace block ~1 ~ ~ container.15 with white_stained_glass_pane[tooltip_display={hide_tooltip: true}, custom_data={connected: []}]
