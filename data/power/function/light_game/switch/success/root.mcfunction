...
$execute if items block ~ ~ ~ container.$(switch) coal[custom_model_data={strings:["red"]},custom_name=""] run item replace block ~ ~ ~ container.$(switch) with coal[custom_data={number:$(switch)},custom_model_data={strings:["green"]},custom_name="change"]
$execute if items block ~ ~ ~ container.$(switch) coal[custom_model_data={strings:["green"]},custom_name=""] run item replace block ~ ~ ~ container.$(switch) with coal[custom_data={number:$(switch)},custom_model_data={strings:["red"]},custom_name="change"]
