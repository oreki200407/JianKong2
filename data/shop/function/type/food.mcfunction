...
item replace entity @s enderchest.22 with potion[potion_contents={potion:"minecraft:strong_strength",custom_color:7881235},custom_name={text:"咖啡",italic:false}, lore=[[{"text": "價格：5", "color": "gold", "italic": false}]],custom_data={type:"shop",price:5}] 1
...
item replace entity @s enderchest.24 with heart_of_the_sea[consumable={sound:"item.honey_bottle.drink",on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:speed",amplifier:1,duration:2400},{id:"minecraft:night_vision",amplifier:0,duration:2400}]},{type:"minecraft:play_sound",sound:"entity.creaking.freeze"}]},item_name="冰淇淋",lore=[[{"text": "價格：5", "color": "gold", "italic": false}],[{"text":"加速 II (2:00)","color":"blue","italic":false}],[{"text":"夜視 (2:00)","color":"blue","italic":false}]],custom_data={type:"shop",price:5}] 1
