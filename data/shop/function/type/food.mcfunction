...
item replace entity @s enderchest.22 with potion[potion_contents={potion:"minecraft:strong_strength",custom_color:7881235, custom_name: "coffee"}, lore=[[{"text": "價格：5", "color": "gold", "italic": false}]],custom_data={type:"shop",price:5}] 1
