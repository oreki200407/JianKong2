...
item replace entity @s enderchest.22 with potion[custom_name={"text":"咖啡",italic:false},potion_contents={potion:"minecraft:strong_strength",custom_color:7881235}, lore=[[{"text": "價格：5", "color": "gold", "italic": false}],[{translate: "potion.withDuration", color: "blue", italic: false, with: [{translate: "potion.withAmplifier", with: [{translate: "effect.minecraft.strength"}, {translate: "potion.potency.1"}]}, "01:30"]}]],custom_data={type:"shop",price:5},tooltip_display={hidden_components:["potion_contents"]}] 1
...
item replace entity @s enderchest.24 with heart_of_the_sea[consumable={sound:"item.honey_bottle.drink",on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:speed",amplifier:1,duration:2400},{id:"minecraft:night_vision",amplifier:0,duration:2400}]},{type:"minecraft:play_sound",sound:"entity.creaking.freeze"}]},item_name="冰淇淋",lore=[[{"text": "價格：5", "color": "gold", "italic": false}],[{translate: "potion.withDuration", color: "blue", italic: false, with: [{translate: "potion.withAmplifier", with: [{translate: "effect.minecraft.speed"}, {translate: "potion.potency.1"}]}, "02:00"]}],[{translate: "potion.withDuration", color: "blue", italic: false, with: [{translate: "potion.withAmplifier", with: [{translate: "effect.minecraft.night_vision"}, {translate: "potion.potency.0"}]}, "02:00"]}]],custom_data={type:"shop",price:5}] 1
