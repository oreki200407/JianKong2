...
item replace entity @s enderchest.13 with golden_axe[custom_name='{"text":"散彈槍","italic":false}',lore=['[{"text": "價格：25", "color": "gold", "italic": false}]','[{"text": "點擊", "color": "gray", "italic": false}, {"keybind": "key.use"}, "使用"]'],custom_data={type:"shop",price:25,"gun": "shotgun"}, consumable={consume_seconds: 99999}, !attribute_modifiers,custom_model_data=2] 1
item replace entity @s enderchest.14 with white_stained_glass_pane[custom_name='""',custom_data={type:"shop"}]
item replace entity @s enderchest.15 with golden_axe[custom_name='{"text":"衝鋒槍","italic":false}',lore=['[{"text": "價格：23", "color": "gold", "italic": false}]','[{"text": "點擊", "color": "gray", "italic": false}, {"keybind": "key.use"}, "使用"]'],custom_data={type:"shop",price:23,"gun": "smg"}, consumable={consume_seconds: 99999}, !attribute_modifiers,custom_model_data=3] 1
item replace entity @s enderchest.16 with white_stained_glass_pane[custom_name='""',custom_data={type:"shop"}]
item replace entity @s enderchest.17 with golden_axe[custom_name='{"text":"電鋸","italic":false}',lore=['[{"text": "價格：27", "color": "gold", "italic": false}]','[{"text": "按住", "color": "gray", "italic": false}, {"keybind": "key.use"}, "使用"]'],custom_data={type:"shop",price:27,"gun": "chainsaw"}, consumable={consume_seconds: 99999}, !attribute_modifiers,custom_model_data=5] 1
